package examples.compat.bubbletea.listdefault;
...
/**
 * Demonstrates the default list delegate with sample items.
 * Upstream: bubbletea/examples/list-default/main.go
...
public class ListDefaultExample implements Model {
    ...
    /**
     * Sample list item with title and description fields.
     */
    record ExampleItem(String title, String desc) implements DefaultItem {
        ...
        /**
         * Returns the item description shown by the default delegate.
         *
        ...
        /**
         * Returns the item title shown by the default delegate.
         *
         * @return title text
         */
        @Override
    ...
    /**
     * Builds the sample list and configures its title and status timing.
     */
    ...
    /**
     * Initializes the list and requests the window size.
     *
     * @return combined init command
     */
    @Override
    public Command init() {
    ...
    /**
     * Updates list sizing, handles status key, and forwards to the list.
     *
    ...
    /**
     * Renders the list inside the document margin.
     *
    ...
    /**
     * Runs the list default example in the alternate screen.
     *
     * @param args ignored
     */

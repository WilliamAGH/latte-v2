...
/**
 * Provides rotating sample items for the fancy list demo.
 * Upstream: bubbletea/examples/list-fancy/randomitems.go
...
public class RandomItemGenerator {
    ...
    /**
     * Seeds the generator with shuffled titles and descriptions.
     */
    ...
    /**
     * Resets and shuffles the data sources.
     */
    private void reset() {
    ...
    /**
     * Returns the next item, cycling through titles and descriptions.
     *

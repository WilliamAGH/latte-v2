...
/**
 * Implements Conway's Game of Life with a ticking update loop.
...
public class Conway implements Model {
    ...
    /**
     * Message used to advance the simulation on a timer.
     */
    ...
    /**
     * Creates a model with seeded live cells.
     *
     * @param width grid width
     * @param height grid height
     * @param initialCells initial live cell set
     */
    ...
    /**
     * Starts the periodic tick that advances the simulation.
     *
     * @return tick command
     */
    @Override
    ...
    /**
     * Advances one generation for each tick message.
     *
    ...
    /**
     * Applies the Game of Life rules to compute the next cell set.
     */
    ...
    /**
     * Counts live neighbors for the given cell.
     *
     * @param point target cell
    ...
    /**
     * Computes the wrapped neighbors for a point on the grid.
     *
     * @param point target cell
     * @return neighbor set
     */
    ...
    /**
     * Renders the current grid state as characters.
     *
    ...
    /**
     * Represents a grid coordinate for live cell tracking.
     */
    private record Point(int x, int y) {
    }

    /**
     * Creates a starter pattern set (glider, blinker, LWSS).
     *
     * @param width grid width
     * @param height grid height
     * @return seeded model
    ...
    /**
     * Seeds the grid randomly using the given live probability.
     *
     * @param width grid width
     * @param height grid height
     * @param liveProbability probability that a cell starts alive
     * @return seeded model
     */

...
public class Fireworks implements Model {
    ...
    /**
     * Support type for the Fireworks example.
     */
    ...
    /**
     * Creates Fireworks to keep example ready for use.
     *
     * @param width width
     * @param height height
     */
    ...
    /**
     * Handles update fireworks for example.
     */
    ...
    /**
     * Handles add new firework with chance for example.
     *
     * @param chance chance
     */
    ...
    private static class Firework {
        ...
        /**
         * Creates Firework to keep example ready for use.
         *
         * @param x x
         * @param y y
         * @param effectBaseColor effect base color
         */
    ...
    private static class Particle {
        ...
        /**
         * Creates Particle to keep example ready for use.
         *
         * @param x x
         * @param y y
         * @param color color
        ...
        /**
         * Handles with speed for example.
         *
        ...
        /**
         * Handles with acceleration for example.
         *
        ...
        /**
         * Handles with fading for example.
         *
         * @param fading fading
         * @return result
         */
